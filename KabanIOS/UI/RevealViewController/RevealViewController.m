...
#pragma mark - RevealViewControllerSegueSetController segue identifiers

NSString * const SegueLeftIdentifier =    @"rv_left";
NSString * const SegueMainIdentifier =    @"rv_main";
NSString * const SegueRightIdentifier =   @"rv_right";

#pragma mark - RevealViewControllerSegueSetController class

@implementation RevealViewControllerSegueSetController

- (void)perform
{
    NSString *identifier = self.identifier;
    
    RevealViewController *rvc = self.sourceViewController;
    UIViewController *dvc = self.destinationViewController;
    
    if ([identifier isEqualToString:SegueMainIdentifier]) {
        [rvc addChildViewController:dvc];
        [dvc didMoveToParentViewController:rvc];
        rvc.mainViewController = dvc;
    } else if ([identifier isEqualToString:SegueLeftIdentifier]) {
        [rvc addChildViewController:dvc];
        [dvc didMoveToParentViewController:rvc];
        rvc.leftViewController = dvc;
    } else if ([identifier isEqualToString:SegueRightIdentifier]) {
        [rvc addChildViewController:dvc];
        [dvc didMoveToParentViewController:rvc];
...
#pragma mark - RevealViewControllerSeguePushController class

@implementation RevealViewControllerSeguePushController

- (void)perform
{
    RevealViewController *rvc = [self.sourceViewController revealViewController];
    UIViewController *dvc = self.destinationViewController;
...
#pragma mark - RevealViewControllerPanGestureRecognizer

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface RevealViewControllerPanGestureRecognizer : UIPanGestureRecognizer

@end

@implementation RevealViewControllerPanGestureRecognizer
{
    BOOL    _dragging;
    CGPoint _beginPoint;
}
...
#pragma mark - ContextTransitioningObject

@interface ContextTransitionObject : NSObject<UIViewControllerContextTransitioning>
@end

@implementation ContextTransitionObject
{
    __weak RevealViewController *_revealController;
...
- (id)initWithRevealController:(RevealViewController*)revealController containerView:(UIView *)containerView fromViewController:(UIViewController *)fromViewController toViewController:(UIViewController*)toViewController completion:(void (^)(void))completion
{
    self = [super init];
...
- (id)initWithFrame:(CGRect)frame controller:(RevealViewController*)revealController
{
...
- (void)initDefaultProperties
{
    ...
    _leftViewBlurEffectStyle = RevealBlurEffectStyleNone;
    ...
    _rightViewBlurEffectStyle = RevealBlurEffectStyleNone;
    
    _replaceViewAnimationDuration = 0.25f;
    
    _swipeVelocity = 250.0f;
    _toggleAnimationType = RevealToggleAnimationTypeNone;
...
- (void)loadView
{
    ...
    self.contentView = [[RevealView alloc] initWithFrame:frame controller:self];
...
- (void)loadStoryboardControllers
{
    if (self.storyboard && _leftViewController == nil)
    {
        ...
        @try
        {
            [self performSegueWithIdentifier:SegueLeftIdentifier sender:nil];
        }
        @catch(NSException *exception) {}
        
        @try
        {
            [self performSegueWithIdentifier:SegueMainIdentifier sender:nil];
        }
        @catch(NSException *exception) {}
        
        @try
        {
            [self performSegueWithIdentifier:SegueRightIdentifier sender:nil];
        }
        @catch(NSException *exception) {}
    }
}
...
- (void)setLeftViewBlurEffectStyle:(RevealBlurEffectStyle)leftViewBlurEffectStyle
{
    _leftViewBlurEffectStyle = leftViewBlurEffectStyle;
    [self reloadSideBlurEffectStyle:_leftViewBlurEffectStyle forController:_leftViewController forOperation:RevealControllerOperationReplaceLeftController];
}
...
- (void)setRightViewBlurEffectStyle:(RevealBlurEffectStyle)rightViewBlurEffectStyle
{
    _rightViewBlurEffectStyle = rightViewBlurEffectStyle;
    
    [self reloadSideBlurEffectStyle:_rightViewBlurEffectStyle forController:_rightViewController forOperation:RevealControllerOperationReplaceRightController];
}

- (void)reloadSideBlurEffectStyle:(RevealBlurEffectStyle)style forController:(UIViewController *)sideViewController forOperation:(RevealControllerOperation)operation
{
    ...
    if (style != RevealBlurEffectStyleNone) {
        ...
        switch (operation) {
            case RevealControllerOperationReplaceLeftController:
            ...
            case RevealControllerOperationReplaceRightController:
...
- (void)setLeftViewController:(UIViewController *)leftViewController animated:(BOOL)animated
{
    ...
    [self reloadSideBlurEffectStyle:_leftViewBlurEffectStyle forController:leftViewController forOperation:RevealControllerOperationReplaceLeftController];
    
    if (_isLeftViewOpen) {
        [self _swapFromViewController:_leftViewController toViewController:leftViewController operation:RevealControllerOperationReplaceLeftController animated:animated];
    }
...
- (void)setMainViewController:(UIViewController *)mainViewController animated:(BOOL)animated
{
    if (_mainViewController && animated) {
        [self _swapFromViewController:_mainViewController toViewController:mainViewController operation:RevealControllerOperationReplaceMainController animated:animated];
    }
...
- (void)setRightViewController:(UIViewController *)rightViewController animated:(BOOL)animated
{
    ...
    [self reloadSideBlurEffectStyle:_rightViewBlurEffectStyle forController:rightViewController forOperation:RevealControllerOperationReplaceRightController];
    
    if (_isRightViewOpen) {
        [self _swapFromViewController:_rightViewController toViewController:rightViewController operation:RevealControllerOperationReplaceRightController animated:animated];
    }
...
- (void)pushMainViewController:(UIViewController *)mainViewController animated:(BOOL)animated {
    RevealControllerOperation operation;
    
    if (_isLeftViewOpen) {
        operation = RevealControllerOperationPushMainControllerFromLeft;
    } else if (_isRightViewOpen) {
        operation = RevealControllerOperationPushMainControllerFromRight;
    } else {
        return;
    }
...
- (void)_swapFromViewController:(UIViewController *)fromViewController toViewController:(UIViewController *)toViewController operation:(RevealControllerOperation)operation animated:(BOOL)animated
{
    ...
    if (fromViewController != toViewController) {
        ...
        switch (operation) {
            ...
            case RevealControllerOperationReplaceMainController:
                [_contentView insertSubview:toViewController.view belowSubview:fromViewController.view];
#if TARGET_OS_IOS
        ...
        if (animator) {
            ContextTransitionObject *transitioningObject = [[ContextTransitionObject alloc]initWithRevealController:self containerView:_contentView fromViewController:fromViewController toViewController:toViewController completion:completion];
...
- (void)_pushFromViewController:(UIViewController *)fromViewController toViewController:(UIViewController *)toViewController operation:(RevealControllerOperation)operation animated:(BOOL)animated
{
    NSTimeInterval duration = animated ? (_isLeftViewOpen ? _leftToggleAnimationDuration : _rightToggleAnimationDuration) : 0.0;
    
    if (fromViewController == toViewController) {
        if (operation == RevealControllerOperationPushMainControllerFromLeft) {
            [self hideLeftViewAnimated:YES];
        }
        if (operation == RevealControllerOperationPushMainControllerFromRight) {
    ...
    if (_toggleAnimationType == RevealToggleAnimationTypeNone) {
        completion();
    } else if (_toggleAnimationType == RevealToggleAnimationTypeCrossDissolve) {
        [UIView transitionWithView:fromViewController.view duration:duration options:UIViewAnimationOptionLayoutSubviews | UIViewAnimationOptionTransitionCrossDissolve animations:^{
            fromViewController.view.hidden = YES;
        } completion:^(BOOL finished) {
            completion();
    ...
    } else if (_toggleAnimationType == RevealToggleAnimationTypePushSideView) {
    ...
    } else if (_toggleAnimationType == RevealToggleAnimationTypeSpring) {
    ...
    } else if (_toggleAnimationType == RevealToggleAnimationTypeCustom) {
...
- (UIPanGestureRecognizer*)panGestureRecognizer
{
    ...
    if ( _panGestureRecognizer == nil ) {
        self.panGestureRecognizer = [[RevealViewControllerPanGestureRecognizer alloc] initWithTarget:self action:@selector(_handlePanGesture:)];
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)recognizer
{
    ...
    if (recognizer == _panGestureRecognizer) {
        ...
        if ([_delegate respondsToSelector:@selector(revealControllerPanGestureShouldBegin:direction:)]) {
            if ([_delegate revealControllerPanGestureShouldBegin:self direction:velocity > 0 ? RevealControllerPanDirectionRight : RevealControllerPanDirectionLeft] == NO) {
                return NO;
            }
        }
...
- (void)notifyPanGestureBegan:(CGFloat)position
{
    if ([_delegate respondsToSelector:@selector(revealControllerPanGestureBegan:direction:)]) {
        ...
        CGFloat velocity = [_panGestureRecognizer velocityInView:_contentView].x;
        [_delegate revealControllerPanGestureBegan:self direction:velocity > 0 ? RevealControllerPanDirectionRight : RevealControllerPanDirectionLeft];
    }
}
...
- (void)notifyPanGestureMoved:(CGFloat)position
{
    if ([_delegate respondsToSelector:@selector(revealControllerPanGestureMoved:direction:)]) {
        ...
        CGFloat velocity = [_panGestureRecognizer velocityInView:_contentView].x;
        [_delegate revealControllerPanGestureMoved:self direction:velocity > 0 ? RevealControllerPanDirectionRight : RevealControllerPanDirectionLeft];
    }
}
...
- (void)notifyPanGestureEnded:(CGFloat)position
{
    ...
    if ([_delegate respondsToSelector:@selector(revealControllerPanGestureEnded:direction:)]) {
        CGFloat velocity = [_panGestureRecognizer velocityInView:_contentView].x;
        [_delegate revealControllerPanGestureEnded:self direction:velocity > 0 ? RevealControllerPanDirectionRight : RevealControllerPanDirectionLeft];
    }
}
